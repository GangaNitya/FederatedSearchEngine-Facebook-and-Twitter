...
public class FTsearch extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    String query=request.getParameter("queries");
           ...
           Query qu=new Query("D:/backup/Sem 2/Info Storage Retrieval/FederateSearchFacebook-Twitter-master/Final Project/indexffolder",query);
           List<SearchResult> results=qu.run();
           PostContent pcontent=new PostContent("D:/backup/Sem 2/Info Storage Retrieval/FederateSearchFacebook-Twitter-master/Final Project/collection_original.txt" );
